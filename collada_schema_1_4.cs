...
//    [DebuggerStepThrough]
    ...
    public class technique
    {
        ...
        // light fields added by cmar for Blender compatibility

        //public string adapt_thresh;
        ...
        //  <soft>3</soft>
        private string spotBlend;
        private string spotSize;
        private string lightSpread;
        private string sunBrightness;
        private string sunEffectType;
        private string sunIntensity;
        private string sunSize;
        private string Type;

        [XmlElement(DataType = "NMTOKEN")]
        public string backscattered_light
        {
            get { return backscatter; }
            set { backscatter = value; }
        }
        [XmlElement(DataType = "NMTOKEN")]
        ...
        [XmlElement(DataType = "NMTOKEN")]
        public string spotblend
        {
            get { return spotBlend; }
            set { spotBlend = value; }
        }
        [XmlElement(DataType = "NMTOKEN")]
        ...
        [XmlElement(DataType = "NMTOKEN")]
        public string sun_brightness
        {
            get { return sunBrightness; }
            set { sunBrightness = value; }
        }
        [XmlElement(DataType = "NMTOKEN")]
        public string sun_effect_type
        {
            get { return sunEffectType; }
            set { sunEffectType = value; }
        }
        [XmlElement(DataType = "NMTOKEN")]
        public string sun_intensity
        {
            get { return sunIntensity; }
            set { sunIntensity = value; }
        }
        [XmlElement(DataType = "NMTOKEN")]
        public string sun_size
        {
            get { return sunSize; }
            set { sunSize = value; }
        }
    ...
    public partial class COLLADA
    {
        ...
        internal static int[] ConvertIntArray(string arrayStr)
        {
            ...
            for (int i = 0; i < ret.Length; i++)
                ret[i] = int.Parse(elements[i], NumberStyles.Integer, CultureInfo.InvariantCulture);
            return ret;
        }
